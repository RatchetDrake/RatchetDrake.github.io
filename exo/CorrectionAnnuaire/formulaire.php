    ...
    <?php
        if (isset($_POST) && !empty($_POST)) {
            ...
            $insert->execute(array(
                ...
                strlen($_POST['postale']) <= 0 ? NULL : $_POST['codepostal'],
                strlen($_POST['adresse']) <= 0 ? NULL : $_POST['adresse'],
                strlen($_POST['date']) <= 0 ? NULL : $_POST['date_de_naissance'],
                $_POST['sexe'],
                strlen($_POST['desc']) <= 0 ? NULL : $_POST['description']
            ));
        }
    ?>
    </body>
